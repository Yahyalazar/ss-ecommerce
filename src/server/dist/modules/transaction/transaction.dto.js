...
__decorate([
    ...
    (0, class_validator_1.IsEnum)(client_1.TRANSACTION_STATUS, {
        message: "Status must be one of: PENDING, PROCESSING, SHIPPED, IN_TRANSIT, DELIVERED, CANCELED, RETURNED, REFUNDED",
    }),
