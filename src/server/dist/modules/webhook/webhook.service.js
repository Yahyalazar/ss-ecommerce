    ...
    handleCheckoutCompletion(session) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (redis_1.default && (yield (0, redis_1.ensureRedisConnection)())) {
                yield redis_1.default.del("dashboard:year-range").catch(() => undefined);
                const keys = yield redis_1.default.keys("dashboard:stats:*").catch(() => []);
                if (keys.length > 0) {
                    yield redis_1.default.del(keys).catch(() => undefined);
                }
            }
