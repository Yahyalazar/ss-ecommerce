interface LoyaltyPointsAwardedTemplateParams {
  name: string;
  pointsAwarded: number;
  currentBalance: number;
}

const loyaltyPointsAwardedTemplate = ({
  name,
  pointsAwarded,
  currentBalance,
}: LoyaltyPointsAwardedTemplateParams) => `
...
export default loyaltyPointsAwardedTemplate;
